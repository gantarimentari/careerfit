...
export default function Navbar() {
  ...
  return (
    <div>
      <div className="h-20">
        <div
          className={`fixed inset-x-0 top-0 z-50 transform-gpu will-change-[padding,transform] transition-[padding,transform] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
            isScrolled ? "px-4 pt-4 sm:px-6" : "px-0 pt-0"
          }`}
        >
          <div
            className={`bg-background border-b border-[#C1C7CE]/50 transform-gpu origin-top transition-[transform,box-shadow,border-radius,background-color] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
              isScrolled
            ...
            <div className="mx-auto px-4 sm:px-20">
              <div className="flex items-center justify-between h-20">
                <div className="flex items-center gap-3">
                  <Link href="/" className="md:text-h-7 text-primary-dark font-semibold md:font-bold text-body-2">
                    CareerFit
                  </Link>
                </div>
